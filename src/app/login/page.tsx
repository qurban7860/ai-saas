...
function LoginContent() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden bg-zinc-950 font-sans pt-10 pb-10">
      ...
      <div className="absolute top-1/4 -right-20 w-96 h-96 bg-primary/20 rounded-full blur-[128px] opacity-60 mix-blend-screen pointer-events-none" />
      <div className="absolute -bottom-32 -left-20 w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[128px] opacity-40 mix-blend-screen pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md p-8 md:p-10 mx-4">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <form onSubmit={handleCredentialsLogin} className="w-full space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-zinc-950/50 border-zinc-800 focus-visible:ring-primary/50 text-white h-11"
                required
              />
            </div>
            <div className="space-y-2">
            ...
            <Button type="submit" disabled={isLoading} className="w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl h-11 font-semibold transition-all">
          ...
          <Button
            ...
            disabled={isLoading}
            size="lg"
            className="w-full relative h-12 rounded-xl bg-white text-zinc-900 hover:bg-zinc-200 transition-colors duration-200"
          >
            <span className="relative z-10 flex items-center justify-center gap-3 font-semibold text-base">
              <svg
                viewBox="0 0 24 24"
                className="w-[18px] h-[18px] float-left"
